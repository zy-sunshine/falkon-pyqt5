...
class SessionManagerDialog(QDialog):
    ...
    def _refresh(self):
        ...
        for session in sessions:
            ...
            item.setText(0, self._SessionFileRole, session.filePath)
            item.setText(0, self._IsBackupSessionRole, session.isBackup)
            item.setText(0, self._IsActiveSessionRole, session.isActive)
            item.setText(0, self._IsDefaultSessionRole, session.isDefault)
